...
class _ProfileScreenState extends State<ProfileScreen> {
      ...
      body: Center(
        child: Column(
          children: [
            ...
            UiHelpper.CustomText(text: "Profile info", height: 20,color: const Color(0XFF00A884),fontweight: FontWeight.bold),
            const SizedBox(height: 30,),
            UiHelpper.CustomText(text: "Please provide your name and an optional", height: 15),
            UiHelpper.CustomText(text: "profile photo", height: 15),
            ...
            GestureDetector(
              ...
              child: pickedimage==null? CircleAvatar(
                ...
                child: Image.asset("assets/images/photo-camera 1.png",height: 45,fit: BoxFit.cover,),
              ) :CircleAvatar(
                radius : 80,
  ...
  _pickImage(ImageSource imagesource) async {
    try{
      ...
      return ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(ex.toString()),backgroundColor: const Color(0XFF05AA82),));
    }
  }
}